...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">ورشتي</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="/" class="menu-link">
                ...
                <div data-i18n="Analytics">لوحة التحكم</div>
              </a>
            </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('product.index') }}" class="menu-link">
                    <div data-i18n="Without menu">قائمة المنتجات</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('unit.index') }}" class="menu-link">
                    <div data-i18n="Without navbar">قائمة الوحدات</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('purchase.index') }}" class="menu-link">
                    <div data-i18n="Without menu">قائمة المشتريات</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">المخزون</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('stock.index') }}" class="menu-link">
                    <div data-i18n="Without menu">قائمة المخزون</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('order.create') }}" class="menu-link">
                    <div data-i18n="Without menu">نقطة البيع</div>
                  </a>
                </li>
