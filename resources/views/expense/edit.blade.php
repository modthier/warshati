    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="m-0 pb-0">تجديث منصرف</h4>
                </div>
                <div>
                ...
                <div class="card-body pt-0">
                        <div class="row">
                            <div class="form-group col-md-12 mb-2">
                                ...
                                <select name="expense_type_id" class="form-control" required>
                                    ...
                                    @foreach ($expenseTypes as $item)
                                        <option value="{{ $item->id }}" @if($expense->expense_type_id == $item->id) selected @endif>{{ $item->expense }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-12 mb-2">
                                ...
                                <input type="number" step="0.1" name="amount" value="{{ $expense->amount }}" required class="form-control">
                            </div>
